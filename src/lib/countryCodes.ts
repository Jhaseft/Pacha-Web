...
/** Converts a flag emoji (🇵🇪) to its ISO 3166-1 alpha-2 code ("pe") */
...
/** Returns the flagcdn.com URL for a flag emoji */
export function flagUrl(flag: string): string {
  return `https://flagcdn.com/w20/${flagToIso(flag)}.png`;
}
