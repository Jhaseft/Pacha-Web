    ...
    <div className="min-h-screen bg-canvas text-ink flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          <h1 className="text-ink text-3xl font-black mb-1">Nueva contraseña</h1>
          <p className="text-ink-soft text-base mb-8">
            Ingresa el código que enviamos a{" "}
            <span className="text-ink font-semibold">{email}</span> y elige una
            nueva contraseña.
          </p>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full bg-card border border-line rounded-xl px-4 py-3 text-ink placeholder-ink-faint outline-none focus:border-brand transition-colors tracking-widest text-center text-xl font-bold"
            />
          </div>
