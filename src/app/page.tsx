        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8">
          ...
          <div className="border-t border-white/5 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="text-white/20 hover:text-white/40 text-xs transition-colors">Términos de uso</a>
              <span className="text-white/10">·</span>
              <a href="#" className="text-white/20 hover:text-white/40 text-xs transition-colors">Privacidad</a>
            </div>
          </div>
        </div>
      </footer>
