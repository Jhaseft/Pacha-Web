        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <FeatureCard
              ...
              desc="Conecta con nuestras anfitrionas en tiempo real. Chatea, desbloquea fotos y vive momentos únicos."
              icon={
            ...
            <FeatureCard
              title="Chat privado"
              desc="Mensajes privados y exclusivos. Desbloquea conversaciones especiales con tus anfitrionas favoritas."
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-[#A11213]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <FeatureCard
              ...
              desc="Accede a fotos e historias exclusivas de tus anfitrionas favoritas desbloqueando contenido con créditos."
              icon={
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-[#A11213]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <section id="contacto" className="py-20 px-5 sm:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-[#A11213] text-xs font-bold uppercase tracking-widest mb-3">Estamos para ayudarte</p>
            <h2 className="text-white text-4xl sm:text-5xl font-black tracking-tight">
              Contáctanos
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {/* WhatsApp */}
            <div className="bg-white/[0.03] border border-white/8 rounded-3xl p-7 hover:border-[#A11213]/30 hover:bg-white/[0.05] transition-all text-center group">
              <div className="w-12 h-12 rounded-2xl bg-[#A11213]/15 border border-[#A11213]/20 flex items-center justify-center mx-auto mb-4 group-hover:bg-[#A11213]/25 transition-colors">
                <svg className="w-6 h-6 text-[#A11213]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-white/50 text-xs font-bold uppercase tracking-wider mb-1">WhatsApp</p>
              <p className="text-white font-black text-lg">+51 999 999 999</p>
              <p className="text-white/30 text-xs mt-1">Lun – Dom · 10am – 11pm</p>
            </div>
            ...
            <div className="bg-white/[0.03] border border-white/8 rounded-3xl p-7 hover:border-[#A11213]/30 hover:bg-white/[0.05] transition-all text-center group">
              ...
              <p className="text-white/50 text-xs font-bold uppercase tracking-wider mb-1">Correo electrónico</p>
              <p className="text-white font-black text-base break-all">contacto@pachamama.pe</p>
              <p className="text-white/30 text-xs mt-1">Respuesta en menos de 24h</p>
            </div>
            ...
            <div className="bg-white/[0.03] border border-white/8 rounded-3xl p-7 hover:border-[#A11213]/30 hover:bg-white/[0.05] transition-all text-center group">
              ...
              <p className="text-white/50 text-xs font-bold uppercase tracking-wider mb-1">Dirección</p>
              <p className="text-white font-black text-base">Tarapoto, Perú</p>
              <p className="text-white/30 text-xs mt-1">San Martín · Jr. _________ s/n</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-white/35 text-sm leading-relaxed max-w-xs">
                La mejor experiencia de karaoke y entretenimiento en Tarapoto, Perú. Conéctate con nuestras anfitrionas y vive momentos únicos.
              </p>

              {/* Social placeholder */}
              <div className="flex items-center gap-3 mt-5">
                <a href="#" aria-label="Instagram" className="w-9 h-9 rounded-xl bg-white/5 hover:bg-[#A11213]/20 border border-white/8 hover:border-[#A11213]/30 flex items-center justify-center transition-all">
                ...
                <a href="#" aria-label="Facebook" className="w-9 h-9 rounded-xl bg-white/5 hover:bg-[#A11213]/20 border border-white/8 hover:border-[#A11213]/30 flex items-center justify-center transition-all">
                  <svg className="w-4 h-4 text-white/50" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </a>
                <a href="#" aria-label="WhatsApp" className="w-9 h-9 rounded-xl bg-white/5 hover:bg-[#A11213]/20 border border-white/8 hover:border-[#A11213]/30 flex items-center justify-center transition-all">
                  <svg className="w-4 h-4 text-white/50" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413Z" />
                  </svg>
                </a>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3 text-sm text-white/35">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>contacto@pachamama.pe</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-[#A11213] mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
